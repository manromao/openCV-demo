...
#include "../openCV-demo/operations/morphology.h"
...
const QMetaObject Morphology::staticMetaObject = {
    { &Function::staticMetaObject, qt_meta_stringdata_Morphology.data,
      qt_meta_data_Morphology,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Morphology::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Morphology.stringdata0))
        return static_cast<void*>(const_cast< Morphology*>(this));
