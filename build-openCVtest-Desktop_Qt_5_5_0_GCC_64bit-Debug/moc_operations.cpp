...
#include "../openCV-demo/operations.h"
...
QT_MOC_LITERAL(1, 11, 21), // "performOperationEvent"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 15) // "onWidgetChanged"

    },
    "Operations\0performOperationEvent\0\0"
    "onWidgetChanged"
};
...
void Operations::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Operations *_t = static_cast<Operations *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->performOperationEvent(); break;
        case 1: _t->onWidgetChanged(); break;
        default: ;
        }
        ...
        {
            typedef void (Operations::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Operations::performOperationEvent)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Operations::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Operations.data,
      qt_meta_data_Operations,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Operations::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Operations.stringdata0))
        return static_cast<void*>(const_cast< Operations*>(this));
...
// SIGNAL 0
void Operations::performOperationEvent()
{
